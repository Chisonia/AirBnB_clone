...
class TestAmenity(unittest.TestCase):
    ...
    def test_init_with_kwargs(self):
        ...
        self.assertEqual(
            amenity.created_at.isoformat(), test_dict['created_at']
            )
        self.assertEqual(
            amenity.updated_at.isoformat(), test_dict['updated_at']
            )
        self.assertEqual(amenity.name, test_dict['name'])

    def test_str(self):
        '''Test __str__ method'''
        amenity_str = "[Amenity] ({}) {}".format(
    ...
    def test_save(self):
        ...
        self.amenity.save()
        self.assertNotEqual(
            self.amenity.updated_at, prev_updated_at
            )
