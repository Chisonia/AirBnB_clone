...
class TestPlace(unittest.TestCase):
    ...
    def test_init_with_kwargs(self):
        ...
        self.assertEqual(
            place.created_at.isoformat(), test_dict['created_at']
            )
        self.assertEqual(
            place.updated_at.isoformat(), test_dict['updated_at']
            )
        ...
        self.assertEqual(
            place.number_bathrooms, test_dict['number_bathrooms']
            )
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            place_dict['description'], self.place.description
            )
        self.assertEqual(
            place_dict['number_rooms'], self.place.number_rooms
            )
        self.assertEqual(
            place_dict['number_bathrooms'], self.place.number_bathrooms
            )
        self.assertEqual(place_dict['max_guest'], self.place.max_guest)
        self.assertEqual(
            place_dict['price_by_night'], self.place.price_by_night
            )
