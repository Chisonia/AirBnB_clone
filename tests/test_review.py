...
class TestReview(unittest.TestCase):
    ...
    def test_init_with_kwargs(self):
        ...
        self.assertEqual(review.created_at.isoformat(), test_dict['created_at'])
        self.assertEqual(review.updated_at.isoformat(), test_dict['updated_at'])
        self.assertEqual(review.place_id, test_dict['place_id'])
        self.assertEqual(review.user_id, test_dict['user_id'])
        self.assertEqual(review.text, test_dict['text'])

    def test_str(self):
        '''Test __str__ method'''
        review_str = '[Review] ({}) {}'.format(self.review.id, self.review.__dict__)
